...
begin      
 ...
 ' W_ItemStock.StockID, W_ItemStock.OpeningQuantity, W_ItemStock.PurchasedQuantity, W_ItemStock.ProducedQuantity, W_ItemStock.ItemID, W_ItemStock.WarehouseID, W_ItemStock.UnitId, W_ItemStock.IssuedQuantity, W_ItemStock.CreatedBy, W_ItemStock.OpeningStockDate, W_ItemStock.RemovedQuantity, ' +
