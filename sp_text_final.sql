...
BEGIN                  
    ...
    BEGIN                
        ...
        BEGIN       
            ...
            (IDFrom, BomId, ItemId, Quantity, Unit, BatchNo, ExpiryDate, WarehouseId, FinalQuantityLeft, CostPrice)     
                                                                                                                                                
            VALUES 
                                                                                                                                                                                                                                          
            (ISNULL(@IdFrom,0), @ValBomId, @ItemId, @Quantity, @ActualUnitId, @BatchNo, @ExpiryDate, @ActualWarehouseId, @Quantity, @Amount)
    ...
    BEGIN        
        ...
        BEGIN     
            ...
            BEGIN
                ...
                (ISNULL(@IdFrom,0), @UpdBomId, @ItemId, @Quantity, @ActualUnitId, @BatchNo, @ExpiryDate, @ActualWarehouseId, @Quantity, @Amount)
