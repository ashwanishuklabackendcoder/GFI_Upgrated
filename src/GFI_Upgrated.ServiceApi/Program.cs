...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "GFI Upgrated API v1");
...
app.MapControllers();
app.MapGet("/", () => Results.Ok(new { Status = "Online", Message = "GFI Upgrated Service API is running.", Timestamp = DateTime.UtcNow }));
