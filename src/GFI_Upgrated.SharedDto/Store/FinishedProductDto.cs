...
public class FinishedProductListRequest
{
...
public class SaveFinishedProductRequest
{
    public long ItemId { get; set; }
    public string ItemName { get; set; } = string.Empty;
    public string ItemCode { get; set; } = string.Empty;
    ...
    public long ItemCatId { get; set; }
    public long ItemTypeId { get; set; } = 1; // Default to Finished Product type
...
public class FinishedProductDetailDto
{
...
public class FinishedProductVendorDto
{
...
public class FinishedProductBatchDto
{
