...
begin      
 ...
 ' (select case when (isnull(W_ItemStock.OpeningQuantity, 0) + isnull(W_ItemStock.PurchasedQuantity, 0)) = 0 then 0 else ' +
 ...
 '  / (isnull(W_ItemStock.OpeningQuantity, 0) + isnull(W_ItemStock.PurchasedQuantity, 0))) ' +
                                                                                                                                                               
 ' * (isnull(W_ItemStock.OpeningQuantity, 0) + isnull(W_ItemStock.PurchasedQuantity, 0) - isnull(W_ItemStock.IssuedQuantity, 0) - isnull(W_ItemStock.RemovedQuantity, 0)) end) as TotalValue ' +
